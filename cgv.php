...
<section class="container legal-page" style="padding:48px 16px;max-width:820px;">
  ...
  <p>Voir détails sur la <a href="returns.php">Politique de retour</a>.</p>
  ...
  <p>Les données personnelles collectées sont traitées conformément à la loi 09-08 et à notre <a href="privacy.php">politique de confidentialité</a>.</p>
